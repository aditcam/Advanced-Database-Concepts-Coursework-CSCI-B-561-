...
\item \bluebullet\ %\textcolor{red}{\bf Practice Problem-not graded}.
...
%\item 
%Typically, the {\tt makeS} function returns a bag instead of a set.   In the following problems,
%you are to conduct
%experiments to measure the execution times to eliminate duplicates (set the working memory to the default
%4MB).   
%
%\begin{enumerate}
...
\item \redbullet\ %\textcolor{red}{\bf Practice problem-not graded}.
